<?php
if(!isset($_POST['txtFlightId']) || strlen($_POST['txtFlightId']) < 2) {
    echo 'FlightId must be at least 2 characters';
    exit();
}
if (strlen($_POST['txtFlightId']) > 50 ) {
    echo 'FlightId must be shorter than 50 characters';
    exit();
}
